...
import com.gtstore.sessionbean.ShoppingCartSongFacade;
...
public class ShoppingCartSongController implements Serializable {
    ...
    public ShoppingCartSongController() {
    }

    public ShoppingCartSong getSelected() {
        if (current == null) {
            current = new ShoppingCartSong();
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ShoppingCartSongCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ShoppingCartSongUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ShoppingCartSongDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public ShoppingCartSong getShoppingCartSong(java.lang.Long id) {
