...
public abstract class AbstractFacade<T> {
    ...
    public List<T> findAll(String query,  Object[] args){
        ...
        javax.persistence.Query q = getEntityManager().createQuery(
                "FROM " + entityClass.getName() + " " + query, 
                entityClass);
    ...
    public List<T> findRange(int[] range) {
        javax.persistence.criteria.CriteriaQuery cq = getEntityManager().getCriteriaBuilder().createQuery();
        String query = cq.select(cq.from(entityClass)).toString();
        javax.persistence.Query q = getEntityManager().createQuery(cq.select(cq.from(entityClass)));
