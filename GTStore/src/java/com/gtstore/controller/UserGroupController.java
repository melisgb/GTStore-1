...
import com.gtstore.sessionbean.UserGroupFacade;
...
public class UserGroupController implements Serializable {
    ...
    @EJB
    private com.gtstore.sessionbean.UserGroupFacade ejbFacade;
    ...
    public UserGroup getUserGroup(java.lang.Long id) {
