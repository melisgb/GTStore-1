...
import com.gtstore.sessionbean.ShoppingCartGameFacade;
...
public class ShoppingCartGameController implements Serializable {
    ...
    public ShoppingCartGameController() {
    }

    public ShoppingCartGame getSelected() {
        if (current == null) {
            current = new ShoppingCartGame();
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ShoppingCartGameCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ShoppingCartGameUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ShoppingCartGameDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public ShoppingCartGame getShoppingCartGame(java.lang.Long id) {
